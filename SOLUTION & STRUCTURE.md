...
| ----- | ----- | ----- | ----- |
| **Nguyễn Thị Kiều Anh** | 2412380009 | **Group Coordinator, Game Mechanisms Design** | \- Master roadmap & project progress management- \- Game rulebook: Develop the comprehensive rulebook covering game objectives, gameplay flow, player actions, investment rules, scoring mechanisms, and other game mechanics. |
