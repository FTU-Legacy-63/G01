...
### **Rule 2 — Capital commitment**

Capital allocation is used as an observable measure of how much capital the player is willing to commit to the company. 

$Capital\ Commitment\ \ =\ \frac{Investment\ amount\ }{Maximum\ investment\ }$ $×$ 100%

* **Reject:** Capital Commitment \= 0  
* **Minimum investment:** Low commitment  
* **Maximum investment:** Capital Commitment \= 100

Capital Commitment is used for two purposes:

1. to compare the player's investment action with the final checklist assessment; and  
2. to determine the equity received and the resulting portfolio return.
