...
**Người dùng chính:** Học sinh, sinh viên các khối ngành Kinh tế/Tài chính/Quản trị và các nhà đầu tư cá nhân mới gia nhập thị trường.

**Tình huống sử dụng:** Thực hành thẩm định doanh nghiệp, luyện tập đọc báo cáo tài chính, học cách quản lý dòng tiền đa thời kỳ và trải nghiệm các kịch bản đầu tư rủi ro trong môi trường mô phỏng an toàn.


## Tính năng chính

**Tính năng 1:** Phòng phỏng vấn & Thẩm định thông tin (Due diligence hub): Tương tác với Founder qua bộ câu hỏi preset, đối chiếu tuyên bố của Founder với dữ liệu thực tế để phát hiện các tín hiệu cảnh báo (Red flags) và kịch bản nói dối/lảng tránh.

**Tính năng 2:** Bảng phân tích tài chính 3 bảng (3-Statement financial viewer): Trực quan hóa Báo cáo kết quả kinh doanh, Bảng cân đối kế toán và Báo cáo lưu chuyển tiền tệ của 5 startups, đi kèm dữ liệu so sánh với trung bình ngành.

**Tính năng 3:** Cơ chế mở khóa thông tin (Analyst forecast sink): Cho phép trích quỹ vốn để mua báo cáo dự báo từ chuyên gia độc lập, giúp đánh đổi giữa chi phí cơ hội và mức độ an toàn thông tin.

**Tính năng 4:** Widget checklist 5 tiêu chí & Tổng kết ROI: Cung cấp bộ công cụ đánh giá 5 trụ cột nội tại doanh nghiệp trước khi quyết định rót vốn, tự động tính toán Lời/Lỗ (ROI) và bóc tách bài học kinh nghiệm sau mỗi ván chơi.
